...
$brands_query = "SELECT DISTINCT brand FROM Product WHERE categoryID = 4 AND status = 'Active' ORDER BY brand";
$brands_result = mysqli_query($conn, $brands_query);

// Get unique accessory type for filter
$com_type_query = "SELECT DISTINCT ps.attributeValue AS Usetype 
                   FROM Product_Specification ps 
                   JOIN Product p ON ps.productID = p.productID 
                   WHERE p.categoryID = 4 AND p.status = 'Active' AND ps.attributeName = 'useType' 
                   ORDER BY Usetype";
...
<body>
    ...
    <!-- Accessories Section -->
    <section class="products-listing" data-category="accessories" data-category-label="Accessories">
        <div class="container">
                ...
                <main class="products-main">
                    <div class="products-header">
                        <div class="results-info">
                            <p>Showing <strong id="total-count-display">0</strong> Accessories</p>
                        </div>
